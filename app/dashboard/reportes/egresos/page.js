    ...
    <div className="min-h-screen bg-slate-50 p-4 md:p-8 print:bg-white print:p-0">
      ...
      <div className="flex flex-wrap justify-between items-center gap-4 mb-8 bg-slate-900 text-white p-4 rounded-2xl shadow-xl print-hidden no-print">
        ...
        <div className="flex items-center gap-4">
          ...
          <button onClick={handlePrint} className="flex items-center gap-2 bg-red-500 hover:bg-red-600 px-4 py-2.5 rounded-xl transition-all font-bold text-sm mt-4 shadow-lg shadow-red-500/20">
            <Printer size={18} weight="bold" /> Imprimir
          </button>
        </div>
      </div>

      <div className="max-w-[1000px] mx-auto bg-[#fffcfc] p-8 md:p-12 shadow-2xl border border-slate-200 print:shadow-none print:border-none print:p-4 rounded-sm report-sheet">
